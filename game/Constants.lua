...
NET_INPUT_DELAY	= 1					-- Amount of input delay to use by default during online matches. Should always be > 0
...
NET_SEND_HISTORY_SIZE = 10			-- The number of inputs we send from the input history buffer. Must be atleast 1.
